...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % % --------------------------1-D涡卷 开始 ---------------------------
% % % %===============case 1 a=0.3,c=0.3,b=0.5不变，改变d=====================
a=0.3;%y(2)的系数.ok
c=0.3;%y(3)的系数
b=0.25;%正弦函数的系数
 %d=0.2    %效果好
...
% fx=-sin(2*3.14159265*b*y(1)).*[sign(y(1)+shitf)-sign(y(1)-shitf)-1];%正确 
% fx=-sin(2*3.14159265*b*y(1)).*[sign(y(1)+shitf_n)-sign(y(1)-shitf_p)-1];%正确 
fx=-sin(2*pi*b*y(1)).*[sign(y(1)+shitf_n)-sign(y(1)-shitf_p)-1];
fy=0;%单涡卷 
dy(1)=100*[y(2)];
dy(2)=100*y(3);
dy(3)=100*[-a*[y(2)]-c*y(3)-d*fx];%p=q=0,k=10的双涡卷
